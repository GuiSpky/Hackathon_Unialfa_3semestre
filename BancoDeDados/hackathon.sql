...
--
-- Host: 127.0.0.1
-- Tempo de geração: 24/06/2024 às 00:40
...
INSERT INTO `agenda` (`id`, `idAgente`, `idIdoso`, `IdVacina`, `dataVisita`, `horaVisita`, `info`, `dataAplicacao`) VALUES
(1, 2, 2, 3, '2024-06-26', '10:31:00', 'testa', '2023-06-02'),
(7, 2, 2, 2, '2024-06-25', '10:30:00', 'Tomou e nao reclamou', '2015-03-17');
...
INSERT INTO `cuidador` (`id`, `idIdoso`, `nome`) VALUES
(1, 2, 'Marcos'),
(2, 1, 'Rosa');
...
--
ALTER TABLE `cuidador`
  ADD CONSTRAINT `fk_idIdoso01` FOREIGN KEY (`idIdoso`) REFERENCES `idoso` (`id`);
COMMIT;
