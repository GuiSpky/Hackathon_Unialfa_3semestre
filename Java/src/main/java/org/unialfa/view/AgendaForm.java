...
public class AgendaForm extends JFrame {
    ...
    public AgendaForm() {
        ...
        campoIdAgente.setSelectedIndex(-1);
        campoIdIdoso.setSelectedIndex(-1);
        campoIdVacina.setSelectedIndex(-1);
        ...
        if (!e.getValueIsAdjusting()) {
            ...
            if (selectedRow != -1) {
                ...
                if (agenda != null) {
                    ...
                    campoIdAgente.setSelectedItem(agenda.getIdAgente());
                    campoIdIdoso.setSelectedItem(agenda.getIdIdoso());
                    campoIdVacina.setSelectedItem(agenda.getIdVacina());
    ...
    private DefaultTableModel carregarDadosAgendas() {
        ...
        for (Agenda agenda : agendas) {
            ...
            model.addRow(new Object[]{
                    ...
                    agenda.getIdAgente(), agenda.getIdIdoso(), agenda.getIdAgente(),
